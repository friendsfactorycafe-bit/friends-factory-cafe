          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-8 max-w-xl">
                Friends Factory Cafe brings premium romantic celebration experiences to couples in {area.name}, Vadodara. Book birthday surprises, candlelight dinners, anniversaries & more!
              </p>
